...
int iAgglParticle = 43; /* we are going to follow the agglomerate of this particle */
...
void reshape(int w, int h)
{
	...
	if (w <= h)
		glOrtho(xfocus-scale*Lx, xfocus+scale*Lx, yfocus-scale*Ly, (yfocus+scale*Ly)*h/w, -1.3e0*Lz, 0.3e0*Lz);
	else
		glOrtho(xfocus-scale*Lx, (xfocus+scale*Lx)*w/h, yfocus-scale*Ly, yfocus+scale*Ly, -1.3e0*Lz, 0.3e0*Lz);
